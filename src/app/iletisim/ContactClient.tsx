...
const DEFAULTS = {
  phone: '0 (850) 123 45 67',
  email: 'info@dsakademi.com.tr',
  address_line1: 'İTÜ Teknokent, Maslak',
  address_line2: 'Sarıyer / İstanbul',
  working_hours: 'Pazartesi – Cuma, 09:00 – 18:00',
  maps_embed_url: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3006.8236546498644!2d29.01711597649073!3d41.10437687133394!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab5bdd35419f1%3A0x7e8a8e8d0e5f1f0!2zxLBUw5wgVGVrbm9rZW50!5e0!3m2!1str!2str!4v1691000000000!5m2!1str!2str',
};

export default function ContactClient({ settings }: Props) {
  const s = settings ?? DEFAULTS as unknown as SiteSettings;
          ...
          <div className="contact-info-side">
            <div className="contact-info-card">
              ...
              <div className="contact-info-text">
                <h3>Telefon</h3>
                <p><a href={`tel:${(s.phone ?? '').replace(/\s/g, '')}`}>{s.phone ?? DEFAULTS.phone}</a></p>
            ...
            <div className="contact-info-card">
              ...
              <div className="contact-info-text">
                <h3>E-posta</h3>
                <p><a href={`mailto:${s.email ?? DEFAULTS.email}`}>{s.email ?? DEFAULTS.email}</a></p>
            ...
            <div className="contact-info-card">
              ...
              <div className="contact-info-text">
                <h3>Adres</h3>
                <p>{s.address_line1 ?? DEFAULTS.address_line1}</p>
                <span>{s.address_line2 ?? DEFAULTS.address_line2}</span>
              </div>
            </div>
            ...
            <div className="contact-info-card">
              ...
              <div className="contact-info-text">
                ...
                {s.working_hours ? (
                  s.working_hours.includes(',') ? (
                    <>
                      <p>{s.working_hours.split(',')[0].trim()}</p>
                      <span>{s.working_hours.split(',')[1].trim()}</span>
                    </>
                  ) : <p>{s.working_hours}</p>
                ) : (
                  <>
        ...
        <div className="container">
          <div className="contact-map-wrapper">
            ...
            <div className="contact-map-embed">
              <iframe
                src={s.maps_embed_url ?? DEFAULTS.maps_embed_url}
                width="100%"
                height="400"
